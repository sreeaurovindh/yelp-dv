...
//    Copyright 2013 Petter 
//
//    This demo code has been kindly provided by Petter Trnberg <pettert@chalmers.se>
...
public class SentimentAnalyser {
	...
	public SentimentAnalyser(String pathToSWN) throws IOException {
	...
	public double extract(String word, String pos) {
		double sentimentscore = Integer.MIN_VALUE;
		if(dictionary.containsKey(word + "#" + pos)){
			sentimentscore = dictionary.get(word + "#" + pos);
		}
	...
	public static void main(String [] args) throws IOException {
		...
		SentimentAnalyser sentiwordnet = new SentimentAnalyser(pathToSWN);
